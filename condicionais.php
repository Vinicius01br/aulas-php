...
<body>
    ...
    $produto = "Ultrabook";
    $qtdEmEstoque = 0;// oque temos no momento
    $qtdCritica = 2;// minímo necessario
    ?>
    <h3>Produto: <?=$produto?></h3>
    <h3>Estoque: <?=$qtdEmEstoque?></h3>

    <?php
    /* Se a quantidade em estoque for baixo da quantidade crítica, o sistema deve avisar e pedir pra repor. */
    ...
    if( $qtdEmEstoque < $qtdCritica){
        ...
        /* Caso contrário, simplesmete falar que o estoque está <normal></normal.*/
